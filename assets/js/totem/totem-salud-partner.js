...
// Configuración de la API Journey Builder (para flujos avanzados)
      ...
      /**
       * Fila virtual (tótem / pago / caja / QR): token, queue, branch por partner.
       * queueVideollamada: cola journey videollamada (misma sucursal y token).
       * Editar cada entrada cuando un partner tenga credenciales propias.
       */
      var FV_DEFAULT_OTROS = {
        queue: '16087',
        branch: '10715',
        queueVideollamada: '16223'
      };
      var FV_BRILLIANT = {
        queue: '3219',
        branch: '119',
      ...
      var PARTNER_FV_CONFIG = {
        brilliant: Object.assign({}, FV_BRILLIANT),
        musux: Object.assign({}, FV_DEFAULT_OTROS),
        remotemedia: Object.assign({}, FV_DEFAULT_OTROS),
        sigroup: Object.assign({}, FV_DEFAULT_OTROS),
        biometrika: Object.assign({}, FV_DEFAULT_OTROS),
        interastar: Object.assign({}, FV_DEFAULT_OTROS),
        keengo: Object.assign({}, FV_DEFAULT_OTROS),
        siitecs: Object.assign({}, FV_DEFAULT_OTROS),
        sisa: Object.assign({}, FV_DEFAULT_OTROS),
        inalambria: Object.assign({}, FV_DEFAULT_OTROS),
        ticservices: Object.assign({}, FV_DEFAULT_OTROS),
        enlace: Object.assign({}, FV_DEFAULT_OTROS),
        conectasalud: Object.assign({}, FV_DEFAULT_OTROS),
        conectafinanciera: Object.assign({}, FV_DEFAULT_OTROS),
        metatelco: Object.assign({}, FV_DEFAULT_OTROS),
        hasar: Object.assign({}, FV_DEFAULT_OTROS),
        avcellll: Object.assign({}, FV_DEFAULT_OTROS),
        mediterranea: Object.assign({}, FV_DEFAULT_OTROS),
        vlera: Object.assign({}, FV_DEFAULT_OTROS)
      };
      
      function normalizePartnerSlug(raw) {
        if (raw == null || String(raw).trim() === '') return '';
        var s = String(raw).trim().toLowerCase();
        if (s === 'brillant') return 'brilliant';
        return s;
      }
      
      function getPartnerSlugFromQuery() {
        var p = new URLSearchParams(window.location.search);
        return normalizePartnerSlug(p.get('partner') || p.get('musux') || '');
      }
      
      function getPartnerFvConfig() {
        var slug = getPartnerSlugFromQuery();
        if (slug && PARTNER_FV_CONFIG[slug]) return PARTNER_FV_CONFIG[slug];
        return FV_DEFAULT_OTROS;
      }
      
      (function initPartnerFromQuery() {
        var slug = getPartnerSlugFromQuery();
        document.body.setAttribute('data-partner', slug || '');
        document.title = 'Tótem de Atención - Salud' + (slug ? ' (' + slug + ')' : '');
      })();
      ...
      async function enqueueTotemSaludFilaVirtual() {
        var cfg = getPartnerFvConfig();
        return FilaVirtualApi.enqueue(cfg.queue, cfg.branch, { dni: dniIngresado });
      }
      ...
      async function solicitarAtencion(tipo) {
        try {
          var cfg = getPartnerFvConfig();
          var queueId = tipo === 'videollamada' ? (cfg.queueVideollamada || '16223') : cfg.queue;
          const data = await FilaVirtualApi.enqueue(queueId, cfg.branch, { dni: dniIngresado });
