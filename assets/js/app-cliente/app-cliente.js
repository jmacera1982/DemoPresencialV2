// Esperar a que el DOM esté completamente cargado
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const menuOpcionesPresencial = document.getElementById('menuOpcionesPresencial');
      const btnOpcionPrestamos = document.getElementById('btnOpcionPrestamos');
      const btnOpcionTarjetas = document.getElementById('btnOpcionTarjetas');
      const btnOpcionInversiones = document.getElementById('btnOpcionInversiones');

      // Verificar que todos los elementos existan
      if (
        !btnSolicitarAtencion ||
        !atencionSection ||
        !stepsContainer ||
        !summarySection ||
        !summaryContent ||
        !opcionesAtencionSection ||
        !opcionesAtencionContainer ||
        !resultadoAtencionApp ||
        !menuOpcionesPresencial ||
        !btnOpcionPrestamos ||
        !btnOpcionTarjetas ||
        !btnOpcionInversiones
      ) {
      ...
      btnSolicitarAtencion.addEventListener('click', (e) => {
        ...
        menuOpcionesPresencial.classList.remove('ac-hidden');
      ...
      async function llamarAgenteConOpcionDesdeMenu(opcion, btn) {
        try {
          ...
          // Ocultar el menú
          menuOpcionesPresencial.classList.add('ac-hidden');
      ...
      window.numiaIniciarVideollamada = async function (btn) {
        ...
        try {
          ...
          if (rawUrl) {
            ...
            window.alert('Tu videollamada fue registrada. Te contactaremos en breve.');
          }
        } catch (err) {
          console.error('Error al iniciar videollamada:', err);
          window.alert('No se pudo iniciar la videollamada: ' + err.message);
        } finally {
          if (triggerBtn) {
...
(function () {
      ...
      if (btnVerCentroAyuda) {
        btnVerCentroAyuda.addEventListener('click', function () {
          window.alert('Centro de ayuda — opción demo.');
        });
      }
